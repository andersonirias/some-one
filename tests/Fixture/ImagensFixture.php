...
class ImagensFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'caminho' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'fk_imagens_eventos' => ['type' => 'index', 'columns' => ['evento'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_imagens_eventos' => ['type' => 'foreign', 'columns' => ['evento'], 'references' => ['eventos', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'evento' => 1,
            'criacao' => '2017-10-27 11:55:00',
            'alteracao' => '2017-10-27 11:55:00'
        ],
    ];
}
