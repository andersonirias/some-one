...
class ListasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_listas_eventos' => ['type' => 'index', 'columns' => ['evento'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_listas_eventos' => ['type' => 'foreign', 'columns' => ['evento'], 'references' => ['eventos', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'evento' => 1,
            'criacao' => '2017-10-27 11:51:05',
            'alteracao' => '2017-10-27 11:51:05'
        ],
    ];
}
