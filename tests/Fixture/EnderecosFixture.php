...
class EnderecosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'complemento' => ['type' => 'string', 'length' => 100, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'fk_enderecos_produtores' => ['type' => 'index', 'columns' => ['produtor'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_enderecos_produtores' => ['type' => 'foreign', 'columns' => ['produtor'], 'references' => ['produtores', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'numero' => 1,
            'produtor' => 1,
            'criacao' => '2017-10-27 11:48:09',
            'alteracao' => '2017-10-27 11:48:09'
        ],
    ];
}
